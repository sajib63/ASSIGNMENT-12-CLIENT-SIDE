          ...
          <div className="lg:py-6 lg:pr-16">
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold text-neutral">Step 1</p>
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold text-neutral">Step 2</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold text-neutral">Step 3</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                <p className="mb-2 text-lg font-bold text-neutral">Step 4</p>
                <p className="text-gray-700">
            ...
            <div className="flex">
              ...
              <div className="pt-1">
                <p className="mb-2 text-lg font-bold text-neutral">Success</p>
                <p className="text-gray-700" />
              </div>
            </div>
          </div>
